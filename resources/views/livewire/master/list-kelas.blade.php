<div>
    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-2">
        <div class="w-full">
            <x-basic-label title="Jurusan" />
            <select wire:model.live.debounce.400ms="filterJurusan" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5">
        ...
        <table class="w-full text-sm text-left rtl:text-right text-gray-500">
            ...
            <tbody>
                ...
                <tr class="bg-white border-b hover:bg-gray-100">
                    <td class="px-6 py-4">
                        {{ ($kelas->currentPage() - 1) * $kelas->perPage() + $key + 1 }}
                    </td>
                    ...
                    <td class="px-6 py-4 text-right">
                        <a href="{{ route('master.kelas.edit', $item->id) }}" class="font-medium text-blue-600 hover:underline">Edit</a>
                    </td>
                </tr>
                @empty
                <tr>
