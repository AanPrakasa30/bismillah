            ...
            <tbody>
                ...
                <tr class="bg-white border-b hover:bg-gray-100">
                    ...
                    <td class="px-6 py-4 text-right">
                        <a href="{{ route('master.user.delete', $item->id) }}" class="font-medium text-red-600 hover:underline">Delete</a>
                        |
                        <a href="{{ route('master.user.edit', $item->id) }}" class="font-medium text-blue-600 hover:underline">Detail</a>
                    </td>
                </tr>
                @empty
                <tr>
