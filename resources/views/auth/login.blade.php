...
<main class="h-dvh flex justify-center items-center p-4">
    <section class="grid grid-cols-1 sm:grid-cols-2 p-4 border border-gray-50 shadow rounded-lg">
        ...
        <div class="flex items-center justify-center mt-10">
            <img src="https://cdn.discordapp.com/attachments/1117792438803779585/1297829514814160926/MAN41.png?ex=6717596c&is=671607ec&hm=89070e12091b737599a138043544c968850e9bc8dadd5df121c7d8474ded9081&" alt="" style="max-width: 300px; height: auto;">
        </div>
        </div>
    </section>
</main>
