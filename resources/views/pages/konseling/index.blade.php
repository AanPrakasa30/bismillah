...
<header class="mb-5">
    ...
    <div class="flex justify-end">
        <a href="{{ route('konseling.create') }}" class="block text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center" type="button">
            Tambah
        </a>
    </div>
            ...
            <tbody>
                ...
                <tr class="bg-white border-b hover:bg-gray-100">
                    ...
                    <td class="px-6 py-4 text-right">
                        <a href="{{ route('konseling.detail', $item->id) }}" class="font-medium text-blue-600 hover:underline">Detail</a>
                    </td>
                </tr>
                @empty
                <tr>
