...
@section('body')
<header class="mb-5">
    <x-main-header title="List Absen" />
                ...
                <div class="relative bg-white rounded-lg shadow">
                    ...
                    <div class="p-4 md:p-5 space-y-4">
                        ...
                        <div class="grid grid-cols-2 gap-5">
                            <a href="{{ route('absen.create') }}" class="w-full border border-gray-100 hover:border-gray-300 shadow h-36 sm:h-64 rounded-lg flex justify-center items-center">
                                <div class="text-gray-500 text-center">
                                    <i class="fa-regular fa-square-plus text-xl sm:text-[3rem]"></i>
                                    <p class="mt-2 font-bold">Create</p>
                                </div>
                            </a>
                            <a href="{{ route('absen.upload') }}" class="w-full border border-gray-100 hover:border-gray-300 shadow h-36 sm:h-64 rounded-lg flex justify-center items-center">
                                <div class="text-gray-500 text-center">
